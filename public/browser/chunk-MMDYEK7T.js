...
// src/app/features/setup/services/setup-state.service.ts
var SetupStateService = class _SetupStateService {
  api = inject(ApiService);
  router = inject(Router);
  currentStepSignal = signal("discover");
  bridgesSignal = signal([]);
  selectedBridgeSignal = signal(null);
  apiKeySignal = signal(null);
  loadingSignal = signal(false);
  errorSignal = signal(null);
  currentStep = this.currentStepSignal.asReadonly();
  bridges = this.bridgesSignal.asReadonly();
  selectedBridge = this.selectedBridgeSignal.asReadonly();
  apiKey = this.apiKeySignal.asReadonly();
  loading = this.loadingSignal.asReadonly();
  error = this.errorSignal.asReadonly();
  stepIndex = computed(() => {
    const steps = ["discover", "register", "loxone", "complete"];
  ...
  saveLoxoneConfig(loxoneIp, loxonePort, loxoneUser, loxonePassword, loxoneHttpPort) {
    this.loadingSignal.set(true);
    this.errorSignal.set(null);
    const config = { loxoneIp, loxonePort };
    ...
    this.api.saveLoxoneConfig(config).subscribe({
      next: () => {
  ...
  static \u0275fac = function SetupStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SetupStateService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SetupStateService, factory: _SetupStateService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SetupStateService, [{
    type: Injectable,
...
// src/app/features/setup/components/bridge-discovery/bridge-discovery.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function BridgeDiscoveryComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function BridgeDiscoveryComponent_Conditional_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-list-option", 13);
    \u0275\u0275listener("click", function BridgeDiscoveryComponent_Conditional_4_For_2_Template_mat_list_option_click_0_listener() {
      const bridge_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.selectBridge(bridge_r2));
    });
  ...
  if (rf & 2) {
    const bridge_r2 = ctx.$implicit;
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(bridge_r2.ip);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("ID: ", bridge_r2.id, "");
  }
}
function BridgeDiscoveryComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-selection-list", 3);
    \u0275\u0275repeaterCreate(1, BridgeDiscoveryComponent_Conditional_4_For_2_Template, 7, 2, "mat-list-option", null, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.state.bridges());
  }
}
function BridgeDiscoveryComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 4);
    \u0275\u0275text(1, "No bridges found automatically.");
    \u0275\u0275elementEnd();
  }
}
function BridgeDiscoveryComponent_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
var BridgeDiscoveryComponent = class _BridgeDiscoveryComponent {
  state = inject(SetupStateService);
  manualIp = "";
  ngOnInit() {
    this.discover();
  }
  ...
  static \u0275fac = function BridgeDiscoveryComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BridgeDiscoveryComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BridgeDiscoveryComponent, selectors: [["app-bridge-discovery"]], decls: 23, vars: 4, consts: [[1, "discovery-step"], [1, "description"], [1, "loading-container"], [3, "multiple"], [1, "no-bridges"], [1, "manual-entry"], [1, "ip-field"], ["matInput", "", "placeholder", "192.168.1.x", 3, "ngModelChange", "ngModel"], ["mat-flat-button", "", "color", "primary", 3, "click", "disabled"], [1, "error-message"], [1, "actions"], ["mat-stroked-button", "", 3, "click"], ["diameter", "40"], [3, "click"], ["matListItemIcon", ""], ["matListItemTitle", ""], ["matListItemLine", ""]], template: function BridgeDiscoveryComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "p", 1);
      \u0275\u0275text(2, " Searching for Philips Hue bridges on your network... ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(3, BridgeDiscoveryComponent_Conditional_3_Template, 4, 0, "div", 2)(4, BridgeDiscoveryComponent_Conditional_4_Template, 3, 1, "mat-selection-list", 3)(5, BridgeDiscoveryComponent_Conditional_5_Template, 2, 0, "p", 4);
      \u0275\u0275elementStart(6, "div", 5)(7, "h4");
      \u0275\u0275text(8, "Or enter IP manually:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "mat-form-field", 6)(10, "mat-label");
      \u0275\u0275text(11, "Bridge IP Address");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "input", 7);
      \u0275\u0275twoWayListener("ngModelChange", function BridgeDiscoveryComponent_Template_input_ngModelChange_12_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.manualIp, $event) || (ctx.manualIp = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(13, "button", 8);
      \u0275\u0275listener("click", function BridgeDiscoveryComponent_Template_button_click_13_listener() {
        return ctx.selectManual();
      });
      ...
      \u0275\u0275text(16, " Continue ");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(17, BridgeDiscoveryComponent_Conditional_17_Template, 2, 1, "div", 9);
      \u0275\u0275elementStart(18, "div", 10)(19, "button", 11);
      \u0275\u0275listener("click", function BridgeDiscoveryComponent_Template_button_click_19_listener() {
        return ctx.discover();
      });
      \u0275\u0275elementStart(20, "mat-icon");
      \u0275\u0275text(21, "refresh");
      \u0275\u0275elementEnd();
      \u0275\u0275text(22, " Search Again ");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.state.loading() ? 3 : ctx.state.bridges().length > 0 ? 4 : 5);
      \u0275\u0275advance(9);
      \u0275\u0275twoWayProperty("ngModel", ctx.manualIp);
      \u0275\u0275advance();
      \u0275\u0275property("disabled", !ctx.manualIp);
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.state.error() ? 17 : -1);
    }
  }, dependencies: [FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, MatButtonModule, MatButton, MatIconModule, MatIcon, MatFormFieldModule, MatFormField, MatLabel, MatInputModule, MatInput, MatListModule, MatSelectionList, MatListOption, MatListItemIcon, MatListItemLine, MatListItemTitle, MatProgressSpinnerModule, MatProgressSpinner], styles: ["\n\n.discovery-step[_ngcontent-%COMP%] {\n  padding: 16px 0;\n}\n.description[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n  opacity: 0.7;\n}\n.loading-container[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 24px;\n  justify-content: center;\n}\n.no-bridges[_ngcontent-%COMP%] {\n  text-align: center;\n  padding: 24px;\n  opacity: 0.6;\n}\n.manual-entry[_ngcontent-%COMP%] {\n  margin-top: 24px;\n  padding-top: 24px;\n  border-top: 1px solid rgba(0, 0, 0, 0.12);\n}\nhtml.dark[_nghost-%COMP%]   .manual-entry[_ngcontent-%COMP%], html.dark   [_nghost-%COMP%]   .manual-entry[_ngcontent-%COMP%] {\n  border-top-color: rgba(255, 255, 255, 0.12);\n}\n.manual-entry[_ngcontent-%COMP%]   h4[_ngcontent-%COMP%] {\n  margin: 0 0 16px 0;\n  opacity: 0.7;\n}\n.ip-field[_ngcontent-%COMP%] {\n  margin-right: 16px;\n}\n.error-message[_ngcontent-%COMP%] {\n  margin-top: 16px;\n  padding: 12px;\n  background: rgba(244, 67, 54, 0.1);\n  border-radius: 4px;\n  color: #f44336;\n}\n.actions[_ngcontent-%COMP%] {\n  margin-top: 24px;\n}\n/*# sourceMappingURL=bridge-discovery.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BridgeDiscoveryComponent, [{
    type: Component,
    args: [{ selector: "app-bridge-discovery", standalone: true, imports: [
      FormsModule,
      MatButtonModule,
      MatIconModule,
      MatFormFieldModule,
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;2089dc357b9bd6a517760baa0a39055d84382bf1741d2bcbd9136807b909cc0a;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/setup/components/bridge-discovery/bridge-discovery.component.ts */\n.discovery-step {\n  padding: 16px 0;\n}\n.description {\n  margin-bottom: 16px;\n  opacity: 0.7;\n}\n.loading-container {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 24px;\n  justify-content: center;\n}\n.no-bridges {\n  text-align: center;\n  padding: 24px;\n  opacity: 0.6;\n}\n.manual-entry {\n  margin-top: 24px;\n  padding-top: 24px;\n  border-top: 1px solid rgba(0, 0, 0, 0.12);\n}\n:host-context(html.dark) .manual-entry {\n  border-top-color: rgba(255, 255, 255, 0.12);\n}\n.manual-entry h4 {\n  margin: 0 0 16px 0;\n  opacity: 0.7;\n}\n.ip-field {\n  margin-right: 16px;\n}\n.error-message {\n  margin-top: 16px;\n  padding: 12px;\n  background: rgba(244, 67, 54, 0.1);\n  border-radius: 4px;\n  color: #f44336;\n}\n.actions {\n  margin-top: 24px;\n}\n/*# sourceMappingURL=bridge-discovery.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BridgeDiscoveryComponent, { className: "BridgeDiscoveryComponent", filePath: "src/app/features/setup/components/bridge-discovery/bridge-discovery.component.ts", lineNumber: 131 });
})();

// src/app/features/setup/components/bridge-registration/bridge-registration.component.ts
function BridgeRegistrationComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
...
function BridgeRegistrationComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 12);
  }
}
function BridgeRegistrationComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
...
var BridgeRegistrationComponent = class _BridgeRegistrationComponent {
  state = inject(SetupStateService);
  register() {
  ...
  static \u0275fac = function BridgeRegistrationComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BridgeRegistrationComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BridgeRegistrationComponent, selectors: [["app-bridge-registration"]], decls: 32, vars: 4, consts: [[1, "registration-step"], [1, "bridge-info"], [1, "bridge-icon"], [1, "bridge-details"], [1, "label"], [1, "value"], [1, "instructions"], [1, "button-image"], [1, "error-message"], [1, "actions"], ["mat-stroked-button", "", 3, "click"], ["mat-flat-button", "", "color", "primary", 3, "click", "disabled"], ["diameter", "20"]], template: function BridgeRegistrationComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(9, "div", 6)(10, "p")(11, "strong");
      \u0275\u0275text(12, "Step 1:");
      \u0275\u0275elementEnd();
      \u0275\u0275text(13, " Press the large round link button on top of your Hue Bridge");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "p")(15, "strong");
      \u0275\u0275text(16, "Step 2:");
      \u0275\u0275elementEnd();
      \u0275\u0275text(17, ' Click the "Register" button below within 30 seconds');
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 7)(19, "mat-icon");
      \u0275\u0275text(20, "touch_app");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "span");
      \u0275\u0275text(22, "Press the bridge button");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(23, BridgeRegistrationComponent_Conditional_23_Template, 2, 1, "div", 8);
      \u0275\u0275elementStart(24, "div", 9)(25, "button", 10);
      \u0275\u0275listener("click", function BridgeRegistrationComponent_Template_button_click_25_listener() {
        return ctx.goBack();
      });
      ...
      \u0275\u0275listener("click", function BridgeRegistrationComponent_Template_button_click_29_listener() {
        return ctx.register();
      });
      \u0275\u0275template(30, BridgeRegistrationComponent_Conditional_30_Template, 1, 0, "mat-spinner", 12)(31, BridgeRegistrationComponent_Conditional_31_Template, 3, 0);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      let tmp_0_0;
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate((tmp_0_0 = ctx.state.selectedBridge()) == null ? null : tmp_0_0.ip);
      \u0275\u0275advance(15);
      \u0275\u0275conditional(ctx.state.error() ? 23 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275property("disabled", ctx.state.loading());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.state.loading() ? 30 : 31);
    }
  }, dependencies: [MatButtonModule, MatButton, MatIconModule, MatIcon, MatProgressSpinnerModule, MatProgressSpinner], styles: ["\n\n.registration-step[_ngcontent-%COMP%] {\n  padding: 16px 0;\n}\n.bridge-info[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 16px;\n  background: rgba(0, 0, 0, 0.03);\n  border-radius: 8px;\n  margin-bottom: 24px;\n}\nhtml.dark[_nghost-%COMP%]   .bridge-info[_ngcontent-%COMP%], html.dark   [_nghost-%COMP%]   .bridge-info[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.05);\n}\n.bridge-icon[_ngcontent-%COMP%] {\n  font-size: 48px;\n  width: 48px;\n  height: 48px;\n  opacity: 0.6;\n}\n.bridge-details[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n}\n.label[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  opacity: 0.6;\n  text-transform: uppercase;\n}\n.value[_ngcontent-%COMP%] {\n  font-size: 1.25rem;\n  font-weight: 500;\n}\n.instructions[_ngcontent-%COMP%] {\n  margin-bottom: 24px;\n}\n.instructions[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 8px 0;\n}\n.button-image[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 8px;\n  padding: 32px;\n  background:\n    linear-gradient(\n      135deg,\n      #e8f5e9 0%,\n      #c8e6c9 100%);\n  border-radius: 8px;\n  margin-bottom: 24px;\n}\nhtml.dark[_nghost-%COMP%]   .button-image[_ngcontent-%COMP%], html.dark   [_nghost-%COMP%]   .button-image[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #1b5e20 0%,\n      #2e7d32 100%);\n}\n.button-image[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 64px;\n  width: 64px;\n  height: 64px;\n  color: #4caf50;\n}\n.error-message[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n  padding: 12px;\n  background: rgba(244, 67, 54, 0.1);\n  border-radius: 4px;\n  color: #f44336;\n}\n.actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 16px;\n}\n.actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   mat-spinner[_ngcontent-%COMP%] {\n  margin-right: 8px;\n}\n/*# sourceMappingURL=bridge-registration.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BridgeRegistrationComponent, [{
    type: Component,
    args: [{ selector: "app-bridge-registration", standalone: true, imports: [MatButtonModule, MatIconModule, MatProgressSpinnerModule], template: `
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;d74a26701515b142cba195791b4afad8a3dc521a6420aecc35c7daebf84ab1f4;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/setup/components/bridge-registration/bridge-registration.component.ts */\n.registration-step {\n  padding: 16px 0;\n}\n.bridge-info {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n  padding: 16px;\n  background: rgba(0, 0, 0, 0.03);\n  border-radius: 8px;\n  margin-bottom: 24px;\n}\n:host-context(html.dark) .bridge-info {\n  background: rgba(255, 255, 255, 0.05);\n}\n.bridge-icon {\n  font-size: 48px;\n  width: 48px;\n  height: 48px;\n  opacity: 0.6;\n}\n.bridge-details {\n  display: flex;\n  flex-direction: column;\n}\n.label {\n  font-size: 0.75rem;\n  opacity: 0.6;\n  text-transform: uppercase;\n}\n.value {\n  font-size: 1.25rem;\n  font-weight: 500;\n}\n.instructions {\n  margin-bottom: 24px;\n}\n.instructions p {\n  margin: 8px 0;\n}\n.button-image {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 8px;\n  padding: 32px;\n  background:\n    linear-gradient(\n      135deg,\n      #e8f5e9 0%,\n      #c8e6c9 100%);\n  border-radius: 8px;\n  margin-bottom: 24px;\n}\n:host-context(html.dark) .button-image {\n  background:\n    linear-gradient(\n      135deg,\n      #1b5e20 0%,\n      #2e7d32 100%);\n}\n.button-image mat-icon {\n  font-size: 64px;\n  width: 64px;\n  height: 64px;\n  color: #4caf50;\n}\n.error-message {\n  margin-bottom: 16px;\n  padding: 12px;\n  background: rgba(244, 67, 54, 0.1);\n  border-radius: 4px;\n  color: #f44336;\n}\n.actions {\n  display: flex;\n  gap: 16px;\n}\n.actions button mat-spinner {\n  margin-right: 8px;\n}\n/*# sourceMappingURL=bridge-registration.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BridgeRegistrationComponent, { className: "BridgeRegistrationComponent", filePath: "src/app/features/setup/components/bridge-registration/bridge-registration.component.ts", lineNumber: 144 });
})();

// src/app/features/setup/components/loxone-config/loxone-config.component.ts
function LoxoneConfigComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "IP address is required");
    \u0275\u0275elementEnd();
  }
}
function LoxoneConfigComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Invalid IP address format");
    \u0275\u0275elementEnd();
  }
}
function LoxoneConfigComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
    \u0275\u0275text(1, "Port is required");
    \u0275\u0275elementEnd();
  }
}
function LoxoneConfigComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-error");
...
function LoxoneConfigComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9)(1, "mat-form-field", 3)(2, "mat-label");
    \u0275\u0275text(3, "Loxone Username");
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "input", 15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "mat-form-field", 3)(6, "mat-label");
    \u0275\u0275text(7, "Loxone Password");
    \u0275\u0275elementEnd();
    \u0275\u0275element(8, "input", 16);
    \u0275\u0275elementStart(9, "button", 17);
    \u0275\u0275listener("click", function LoxoneConfigComponent_Conditional_23_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(17, "Miniserver web interface port (default: 80)");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function LoxoneConfigComponent_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 10);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function LoxoneConfigComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-spinner", 14);
  }
}
function LoxoneConfigComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-icon");
    \u0275\u0275text(1, "check");
    \u0275\u0275elementEnd();
    \u0275\u0275text(2, " Save Configuration ");
  }
}
var LoxoneConfigComponent = class _LoxoneConfigComponent {
  fb = inject(FormBuilder);
  state = inject(SetupStateService);
  showBidirectional = signal(false);
  showPassword = signal(false);
  form = this.fb.group({
    loxoneIp: ["", [Validators.required, ipAddressValidator()]],
    loxonePort: [7e3, [Validators.required, portValidator()]],
    loxoneUser: [""],
    loxonePassword: [""],
    loxoneHttpPort: [80]
  });
  ...
  save() {
    if (!this.isFormValid())
      return;
    if (this.showBidirectional()) {
      this.state.saveLoxoneConfig(this.form.controls.loxoneIp.value, this.form.controls.loxonePort.value, this.form.controls.loxoneUser.value, this.form.controls.loxonePassword.value, this.form.controls.loxoneHttpPort.value);
    } else {
      this.state.saveLoxoneConfig(this.form.controls.loxoneIp.value, this.form.controls.loxonePort.value);
    }
  }
  goBack() {
    this.state.goBack();
  }
  static \u0275fac = function LoxoneConfigComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LoxoneConfigComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoxoneConfigComponent, selectors: [["app-loxone-config"]], decls: 33, vars: 10, consts: [[1, "loxone-step"], [1, "description"], [1, "loxone-form", 3, "formGroup"], [1, "form-field-full-width"], ["matInput", "", "formControlName", "loxoneIp", "placeholder", "192.168.1.x"], ["matInput", "", "formControlName", "loxonePort", "type", "number"], [1, "bidirectional-section"], [3, "change", "checked"], [1, "section-hint"], [1, "bidirectional-fields"], [1, "error-message"], [1, "actions"], ["mat-stroked-button", "", 3, "click"], ["mat-flat-button", "", "color", "primary", 3, "click", "disabled"], ["diameter", "20"], ["matInput", "", "formControlName", "loxoneUser"], ["matInput", "", "formControlName", "loxonePassword", 3, "type"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], ["matInput", "", "formControlName", "loxoneHttpPort", "type", "number"]], template: function LoxoneConfigComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "p", 1);
      \u0275\u0275text(2, " Configure your Loxone Miniserver connection. The bridge will send UDP commands to this address. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "form", 2)(4, "mat-form-field", 3)(5, "mat-label");
      \u0275\u0275text(6, "Miniserver IP Address");
      \u0275\u0275elementEnd();
      \u0275\u0275element(7, "input", 4);
      \u0275\u0275template(8, LoxoneConfigComponent_Conditional_8_Template, 2, 0, "mat-error")(9, LoxoneConfigComponent_Conditional_9_Template, 2, 0, "mat-error");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "mat-form-field", 3)(11, "mat-label");
      \u0275\u0275text(12, "UDP Port");
      \u0275\u0275elementEnd();
      \u0275\u0275element(13, "input", 5);
      \u0275\u0275template(14, LoxoneConfigComponent_Conditional_14_Template, 2, 0, "mat-error")(15, LoxoneConfigComponent_Conditional_15_Template, 2, 0, "mat-error");
      \u0275\u0275elementStart(16, "mat-hint");
      \u0275\u0275text(17, "Default: 7000");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 6)(19, "mat-slide-toggle", 7);
      \u0275\u0275listener("change", function LoxoneConfigComponent_Template_mat_slide_toggle_change_19_listener($event) {
        return ctx.showBidirectional.set($event.checked);
      });
      \u0275\u0275text(20, " Enable Bidirectional Sync (Optional) ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "p", 8);
      \u0275\u0275text(22, " Enable two-way sync between Hue lights and Loxone. Requires Miniserver credentials. ");
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, LoxoneConfigComponent_Conditional_23_Template, 18, 2, "div", 9);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(24, LoxoneConfigComponent_Conditional_24_Template, 2, 1, "div", 10);
      \u0275\u0275elementStart(25, "div", 11)(26, "button", 12);
      \u0275\u0275listener("click", function LoxoneConfigComponent_Template_button_click_26_listener() {
        return ctx.goBack();
      });
      ...
      \u0275\u0275listener("click", function LoxoneConfigComponent_Template_button_click_30_listener() {
        return ctx.save();
      });
      \u0275\u0275template(31, LoxoneConfigComponent_Conditional_31_Template, 1, 0, "mat-spinner", 14)(32, LoxoneConfigComponent_Conditional_32_Template, 3, 0);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.form.controls.loxoneIp.hasError("required") ? 8 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.form.controls.loxoneIp.hasError("invalidIpAddress") ? 9 : -1);
      \u0275\u0275advance(5);
      \u0275\u0275conditional(ctx.form.controls.loxonePort.hasError("required") ? 14 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.form.controls.loxonePort.hasError("invalidPort") ? 15 : -1);
      \u0275\u0275advance(4);
      \u0275\u0275property("checked", ctx.showBidirectional());
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.showBidirectional() ? 23 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.state.error() ? 24 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275property("disabled", !ctx.isFormValid() || ctx.state.loading());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.state.loading() ? 31 : 32);
    }
  }, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NumberValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, MatButtonModule, MatButton, MatIconButton, MatIconModule, MatIcon, MatFormFieldModule, MatFormField, MatLabel, MatHint, MatError, MatSuffix, MatInputModule, MatInput, MatProgressSpinnerModule, MatProgressSpinner, MatSlideToggleModule, MatSlideToggle], styles: ["\n\n.loxone-step[_ngcontent-%COMP%] {\n  padding: 16px 0;\n}\n.description[_ngcontent-%COMP%] {\n  margin-bottom: 24px;\n  opacity: 0.7;\n}\n.loxone-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  margin-bottom: 24px;\n}\n.bidirectional-section[_ngcontent-%COMP%] {\n  margin-top: 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.section-hint[_ngcontent-%COMP%] {\n  margin: 0;\n  font-size: 0.85rem;\n  opacity: 0.6;\n}\n.bidirectional-fields[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  padding: 16px;\n  border-radius: 8px;\n  background: rgba(0, 0, 0, 0.02);\n}\nhtml.dark[_nghost-%COMP%]   .bidirectional-fields[_ngcontent-%COMP%], html.dark   [_nghost-%COMP%]   .bidirectional-fields[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.05);\n}\n.error-message[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n  padding: 12px;\n  background: rgba(244, 67, 54, 0.1);\n  border-radius: 4px;\n  color: #f44336;\n}\n.actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 16px;\n}\n.actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]   mat-spinner[_ngcontent-%COMP%] {\n  margin-right: 8px;\n}\n/*# sourceMappingURL=loxone-config.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoxoneConfigComponent, [{
    type: Component,
    args: [{ selector: "app-loxone-config", standalone: true, imports: [
      ReactiveFormsModule,
      MatButtonModule,
      MatIconModule,
      MatFormFieldModule,
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;1857477cd966aa1a23a667912ece701ec6582458b7c8f9a5103dbec3e1e088ca;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/setup/components/loxone-config/loxone-config.component.ts */\n.loxone-step {\n  padding: 16px 0;\n}\n.description {\n  margin-bottom: 24px;\n  opacity: 0.7;\n}\n.loxone-form {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  margin-bottom: 24px;\n}\n.bidirectional-section {\n  margin-top: 8px;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.section-hint {\n  margin: 0;\n  font-size: 0.85rem;\n  opacity: 0.6;\n}\n.bidirectional-fields {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n  padding: 16px;\n  border-radius: 8px;\n  background: rgba(0, 0, 0, 0.02);\n}\n:host-context(html.dark) .bidirectional-fields {\n  background: rgba(255, 255, 255, 0.05);\n}\n.error-message {\n  margin-bottom: 16px;\n  padding: 12px;\n  background: rgba(244, 67, 54, 0.1);\n  border-radius: 4px;\n  color: #f44336;\n}\n.actions {\n  display: flex;\n  gap: 16px;\n}\n.actions button mat-spinner {\n  margin-right: 8px;\n}\n/*# sourceMappingURL=loxone-config.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoxoneConfigComponent, { className: "LoxoneConfigComponent", filePath: "src/app/features/setup/components/loxone-config/loxone-config.component.ts", lineNumber: 173 });
})();

// src/app/features/setup/components/setup-complete/setup-complete.component.ts
var SetupCompleteComponent = class _SetupCompleteComponent {
  state = inject(SetupStateService);
  finish() {
    this.state.finishSetup();
  }
  static \u0275fac = function SetupCompleteComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SetupCompleteComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SetupCompleteComponent, selectors: [["app-setup-complete"]], decls: 12, vars: 0, consts: [[1, "complete-step"], [1, "success-icon"], ["mat-flat-button", "", "color", "primary", 3, "click"]], template: function SetupCompleteComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "mat-icon");
      \u0275\u0275text(3, "check_circle");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(4, "h2");
      \u0275\u0275text(5, "Setup Complete!");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "p");
      \u0275\u0275text(7, " Your loxHueBridge is now configured and ready to use. You can start mapping your Hue devices to Loxone. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "button", 2);
      \u0275\u0275listener("click", function SetupCompleteComponent_Template_button_click_8_listener() {
        return ctx.finish();
      });
      \u0275\u0275elementStart(9, "mat-icon");
      \u0275\u0275text(10, "dashboard");
      \u0275\u0275elementEnd();
      \u0275\u0275text(11, " Go to Dashboard ");
      \u0275\u0275elementEnd()();
    }
  }, dependencies: [MatButtonModule, MatButton, MatIconModule, MatIcon], styles: ["\n\n.complete-step[_ngcontent-%COMP%] {\n  padding: 32px 16px;\n  text-align: center;\n}\n.success-icon[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%] {\n  font-size: 80px;\n  width: 80px;\n  height: 80px;\n  color: #4caf50;\n}\nh2[_ngcontent-%COMP%] {\n  margin: 16px 0 8px 0;\n}\np[_ngcontent-%COMP%] {\n  margin: 0 0 24px 0;\n  opacity: 0.7;\n}\n/*# sourceMappingURL=setup-complete.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SetupCompleteComponent, [{
    type: Component,
    args: [{ selector: "app-setup-complete", standalone: true, imports: [MatButtonModule, MatIconModule], template: `
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;b126d6f6806ebb18f23cb4e3474e5c055be6e01557f30b230f64bda2c7e42a3f;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/setup/components/setup-complete/setup-complete.component.ts */\n.complete-step {\n  padding: 32px 16px;\n  text-align: center;\n}\n.success-icon mat-icon {\n  font-size: 80px;\n  width: 80px;\n  height: 80px;\n  color: #4caf50;\n}\nh2 {\n  margin: 16px 0 8px 0;\n}\np {\n  margin: 0 0 24px 0;\n  opacity: 0.7;\n}\n/*# sourceMappingURL=setup-complete.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SetupCompleteComponent, { className: "SetupCompleteComponent", filePath: "src/app/features/setup/components/setup-complete/setup-complete.component.ts", lineNumber: 50 });
})();

// src/app/features/setup/components/setup-wizard/setup-wizard.component.ts
var SetupWizardComponent = class _SetupWizardComponent {
  state = inject(SetupStateService);
  ngOnInit() {
    this.state.reset();
  }
  static \u0275fac = function SetupWizardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SetupWizardComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SetupWizardComponent, selectors: [["app-setup-wizard"]], decls: 16, vars: 4, consts: [[1, "setup-container"], [1, "setup-card"], ["src", "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%2385c440'%3E%3Cpath d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z'/%3E%3C/svg%3E", "alt", "Logo", 1, "logo"], ["orientation", "vertical", 3, "selectedIndex"], ["label", "Discover Bridge", 3, "completed"], ["label", "Register", 3, "completed"], ["label", "Loxone Config", 3, "completed"], ["label", "Complete"]], template: function SetupWizardComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "mat-card", 1)(2, "mat-card-header")(3, "mat-card-title");
      \u0275\u0275element(4, "img", 2);
      \u0275\u0275text(5, " loxHueBridge Setup ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "mat-card-content")(7, "mat-stepper", 3)(8, "mat-step", 4);
      \u0275\u0275element(9, "app-bridge-discovery");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "mat-step", 5);
      \u0275\u0275element(11, "app-bridge-registration");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "mat-step", 6);
      \u0275\u0275element(13, "app-loxone-config");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "mat-step", 7);
      \u0275\u0275element(15, "app-setup-complete");
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      \u0275\u0275property("selectedIndex", ctx.state.stepIndex());
      \u0275\u0275advance();
      \u0275\u0275property("completed", ctx.state.stepIndex() > 0);
      \u0275\u0275advance(2);
      \u0275\u0275property("completed", ctx.state.stepIndex() > 1);
      \u0275\u0275advance(2);
      \u0275\u0275property("completed", ctx.state.stepIndex() > 2);
    }
  }, dependencies: [
    MatCardModule,
    MatCard,
  ...
  ], styles: ["\n\n.setup-container[_ngcontent-%COMP%] {\n  min-height: 100vh;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 24px;\n  box-sizing: border-box;\n}\n.setup-card[_ngcontent-%COMP%] {\n  max-width: 600px;\n  width: 100%;\n}\nmat-card-header[_ngcontent-%COMP%] {\n  margin-bottom: 24px;\n}\nmat-card-title[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  font-size: 1.5rem;\n}\n.logo[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 40px;\n}\n/*# sourceMappingURL=setup-wizard.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SetupWizardComponent, [{
    type: Component,
    args: [{ selector: "app-setup-wizard", standalone: true, imports: [
      MatCardModule,
      MatStepperModule,
      MatProgressSpinnerModule,
      BridgeDiscoveryComponent,
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;d0bcf95fb588da3515167ea2a998ce792de535867984b2edf4bb9bf419f3fded;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/setup/components/setup-wizard/setup-wizard.component.ts */\n.setup-container {\n  min-height: 100vh;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 24px;\n  box-sizing: border-box;\n}\n.setup-card {\n  max-width: 600px;\n  width: 100%;\n}\nmat-card-header {\n  margin-bottom: 24px;\n}\nmat-card-title {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  font-size: 1.5rem;\n}\n.logo {\n  width: 40px;\n  height: 40px;\n}\n/*# sourceMappingURL=setup-wizard.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SetupWizardComponent, { className: "SetupWizardComponent", filePath: "src/app/features/setup/components/setup-wizard/setup-wizard.component.ts", lineNumber: 86 });
})();

// src/app/features/setup/setup.routes.ts
var SETUP_ROUTES = [
...
//# sourceMappingURL=chunk-MMDYEK7T.js.map
