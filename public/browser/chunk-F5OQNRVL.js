...
// src/app/features/lights/services/lights-state.service.ts
var LightsStateService = class _LightsStateService {
  api = inject(ApiService);
  targetsSignal = signal([]);
  mappingsSignal = signal([]);
  statusSignal = signal({});
  detectedSignal = signal([]);
  loadingSignal = signal(false);
  errorSignal = signal(null);
  targets = this.targetsSignal.asReadonly();
  mappings = this.mappingsSignal.asReadonly();
  status = this.statusSignal.asReadonly();
  detected = this.detectedSignal.asReadonly();
  loading = this.loadingSignal.asReadonly();
  error = this.errorSignal.asReadonly();
  // Filter only light/group mappings
  lightMappings = computed(() => this.mappings().filter((m) => m.hue_type === "light" || m.hue_type === "group"));
  // Available targets (lights and groups not already mapped)
  availableLightTargets = computed(() => {
    const mappedIds = new Set(this.lightMappings().map((m) => m.hue_id));
    return this.targets().filter((t) => (t.type === "light" || t.type === "group") && !mappedIds.has(t.uuid));
  });
  // Mappings with current status merged
  mappingsWithStatus = computed(() => {
    const statusMap = this.status();
    return this.lightMappings().map((m) => __spreadProps(__spreadValues({}, m), {
  ...
  updateMapping(loxoneName, update) {
    this.api.updateMapping(loxoneName, update).subscribe({
      next: (updated) => {
        this.mappingsSignal.update((mappings) => mappings.map((m) => m.loxone_name === loxoneName ? __spreadValues(__spreadValues({}, m), updated) : m));
      },
      error: (err) => {
        this.errorSignal.set(err.message);
      }
  ...
  deleteMapping(loxoneName) {
    this.api.deleteMapping(loxoneName).subscribe({
      next: () => {
        this.mappingsSignal.update((mappings) => mappings.filter((m) => m.loxone_name !== loxoneName));
      },
      error: (err) => {
        this.errorSignal.set(err.message);
      }
  ...
  static \u0275fac = function LightsStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _LightsStateService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _LightsStateService, factory: _LightsStateService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LightsStateService, [{
    type: Injectable,
...
var ConfirmDialogComponent = class _ConfirmDialogComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfirmDialogComponent, selectors: [["app-confirm-dialog"]], decls: 10, vars: 5, consts: [["mat-dialog-title", ""], ["align", "end"], ["mat-button", "", 3, "click"], ["mat-flat-button", "", 3, "click", "color"]], template: function ConfirmDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;107440095bb8cabba2ecfb7ee9e09258f2d7382802656b9be217414949c29ae6;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/shared/components/confirm-dialog/confirm-dialog.component.ts */\nmat-dialog-content p {\n  margin: 0;\n}\n/*# sourceMappingURL=confirm-dialog.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfirmDialogComponent, { className: "ConfirmDialogComponent", filePath: "src/app/shared/components/confirm-dialog/confirm-dialog.component.ts", lineNumber: 40 });
})();
...
//# sourceMappingURL=chunk-F5OQNRVL.js.map
