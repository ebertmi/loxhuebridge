...
// src/app/features/diagnostics/services/diagnostics-state.service.ts
var DiagnosticsStateService = class _DiagnosticsStateService {
  ...
  lights = computed(() => this.data()?.lights ?? []);
  sensors = computed(() => this.data()?.sensors ?? []);
  buttons = computed(() => this.data()?.buttons ?? []);
  bridge = computed(() => this.data()?.bridge ?? null);
  unreachableCount = computed(() => {
    const data = this.data();
    if (!data)
      return 0;
    return [...data.lights ?? [], ...data.sensors ?? [], ...data.buttons ?? []].filter((d) => !d.reachable).length;
  });
  lowBatteryDevices = computed(() => {
    const data = this.data();
    if (!data)
      return [];
    return [...data.sensors ?? [], ...data.buttons ?? []].filter((d) => d.battery !== void 0 && d.battery < 20);
  });
  loadDiagnostics() {
  ...
  static \u0275fac = function DiagnosticsStateService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DiagnosticsStateService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DiagnosticsStateService, factory: _DiagnosticsStateService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DiagnosticsStateService, [{
    type: Injectable,
...
// src/app/features/diagnostics/components/device-status-table/device-status-table.component.ts
function DeviceStatusTableComponent_th_12_Template(rf, ctx) {
  if (rf & 1) {
...
function DeviceStatusTableComponent_td_13_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(device_r1.name);
  }
}
function DeviceStatusTableComponent_th_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 12);
    \u0275\u0275text(1, "Type");
    \u0275\u0275elementEnd();
...
function DeviceStatusTableComponent_td_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(device_r2.type);
  }
}
function DeviceStatusTableComponent_th_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 12);
    \u0275\u0275text(1, "Status");
    \u0275\u0275elementEnd();
...
function DeviceStatusTableComponent_td_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 13);
    \u0275\u0275element(1, "app-badge", 14);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const device_r3 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("variant", device_r3.reachable ? "on" : "unreachable")("text", device_r3.reachable ? "Connected" : "Unreachable");
  }
}
function DeviceStatusTableComponent_th_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 12);
    \u0275\u0275text(1, "Battery");
    \u0275\u0275elementEnd();
...
function DeviceStatusTableComponent_td_22_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-badge", 15);
  }
  if (rf & 2) {
    const device_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("text", device_r4.battery + "%")("lowBattery", device_r4.battery < 20);
  }
}
function DeviceStatusTableComponent_td_22_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function DeviceStatusTableComponent_td_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 13);
    \u0275\u0275template(1, DeviceStatusTableComponent_td_22_Conditional_1_Template, 1, 2, "app-badge", 15)(2, DeviceStatusTableComponent_td_22_Conditional_2_Template, 2, 0, "span", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const device_r4 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275conditional(device_r4.battery !== void 0 ? 1 : 2);
  }
}
function DeviceStatusTableComponent_th_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 12);
    \u0275\u0275text(1, "Firmware");
    \u0275\u0275elementEnd();
...
function DeviceStatusTableComponent_td_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 13);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", device_r5.firmware || "-", " ");
  }
}
function DeviceStatusTableComponent_tr_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 17);
  }
}
function DeviceStatusTableComponent_tr_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 18);
  }
  if (rf & 2) {
    const row_r6 = ctx.$implicit;
    \u0275\u0275classProp("unreachable", !row_r6.reachable);
  }
}
var DeviceStatusTableComponent = class _DeviceStatusTableComponent {
  title = input.required();
  icon = input.required();
  devices = input.required();
  displayedColumns = ["name", "type", "status", "battery", "firmware"];
  static \u0275fac = function DeviceStatusTableComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DeviceStatusTableComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DeviceStatusTableComponent, selectors: [["app-device-status-table"]], inputs: { title: [1, "title"], icon: [1, "icon"], devices: [1, "devices"] }, decls: 28, vars: 6, consts: [["matCardAvatar", ""], [1, "table-container"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "name"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "type"], ["matColumnDef", "status"], ["matColumnDef", "battery"], ["matColumnDef", "firmware"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 3, "unreachable", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], [3, "variant", "text"], ["variant", "battery", 3, "text", "lowBattery"], [1, "na"], ["mat-header-row", ""], ["mat-row", ""]], template: function DeviceStatusTableComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "mat-card")(1, "mat-card-header")(2, "mat-icon", 0);
      \u0275\u0275text(3);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "mat-card-content")(9, "div", 1)(10, "table", 2);
      \u0275\u0275elementContainerStart(11, 3);
      \u0275\u0275template(12, DeviceStatusTableComponent_th_12_Template, 2, 0, "th", 4)(13, DeviceStatusTableComponent_td_13_Template, 2, 1, "td", 5);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(14, 6);
      \u0275\u0275template(15, DeviceStatusTableComponent_th_15_Template, 2, 0, "th", 4)(16, DeviceStatusTableComponent_td_16_Template, 2, 1, "td", 5);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(17, 7);
      \u0275\u0275template(18, DeviceStatusTableComponent_th_18_Template, 2, 0, "th", 4)(19, DeviceStatusTableComponent_td_19_Template, 2, 2, "td", 5);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(20, 8);
      \u0275\u0275template(21, DeviceStatusTableComponent_th_21_Template, 2, 0, "th", 4)(22, DeviceStatusTableComponent_td_22_Template, 3, 1, "td", 5);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275elementContainerStart(23, 9);
      \u0275\u0275template(24, DeviceStatusTableComponent_th_24_Template, 2, 0, "th", 4)(25, DeviceStatusTableComponent_td_25_Template, 2, 1, "td", 5);
      \u0275\u0275elementContainerEnd();
      \u0275\u0275template(26, DeviceStatusTableComponent_tr_26_Template, 1, 0, "tr", 10)(27, DeviceStatusTableComponent_tr_27_Template, 1, 2, "tr", 11);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1("", ctx.devices().length, " devices");
      \u0275\u0275advance(3);
      \u0275\u0275property("dataSource", ctx.devices());
      \u0275\u0275advance(16);
      \u0275\u0275property("matHeaderRowDef", ctx.displayedColumns);
      \u0275\u0275advance();
      \u0275\u0275property("matRowDefColumns", ctx.displayedColumns);
    }
  }, dependencies: [MatCardModule, MatCard, MatCardAvatar, MatCardContent, MatCardHeader, MatCardSubtitle, MatCardTitle, MatTableModule, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatIconModule, MatIcon, BadgeComponent], styles: ["\n\n.table-container[_ngcontent-%COMP%] {\n  overflow-x: auto;\n}\ntable[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.na[_ngcontent-%COMP%] {\n  opacity: 0.4;\n}\n.unreachable[_ngcontent-%COMP%] {\n  opacity: 0.6;\n  background: rgba(244, 67, 54, 0.05);\n}\n/*# sourceMappingURL=device-status-table.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DeviceStatusTableComponent, [{
    type: Component,
    args: [{ selector: "app-device-status-table", standalone: true, imports: [MatCardModule, MatTableModule, MatIconModule, BadgeComponent], template: `
    <mat-card>
      <mat-card-header>
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;b5051d94605fec989b8a3618f3535770d606adb722ec72c7449926840e19a527;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/diagnostics/components/device-status-table/device-status-table.component.ts */\n.table-container {\n  overflow-x: auto;\n}\ntable {\n  width: 100%;\n}\n.na {\n  opacity: 0.4;\n}\n.unreachable {\n  opacity: 0.6;\n  background: rgba(244, 67, 54, 0.05);\n}\n/*# sourceMappingURL=device-status-table.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DeviceStatusTableComponent, { className: "DeviceStatusTableComponent", filePath: "src/app/features/diagnostics/components/device-status-table/device-status-table.component.ts", lineNumber: 90 });
})();

// src/app/features/diagnostics/components/bridge-status-card/bridge-status-card.component.ts
function BridgeStatusCardComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "span", 3);
    \u0275\u0275text(2, "API Version");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.bridge().api_version);
  }
}
function BridgeStatusCardComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "span", 3);
    \u0275\u0275text(2, "Software Version");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 5);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.bridge().software_version);
  }
}
function BridgeStatusCardComponent_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 2)(1, "span", 3);
    \u0275\u0275text(2, "Zigbee Channel");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 5);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.bridge().zigbee_channel);
  }
}
var BridgeStatusCardComponent = class _BridgeStatusCardComponent {
  bridge = input.required();
  static \u0275fac = function BridgeStatusCardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BridgeStatusCardComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BridgeStatusCardComponent, selectors: [["app-bridge-status-card"]], inputs: { bridge: [1, "bridge"] }, decls: 17, vars: 6, consts: [["matCardAvatar", ""], [1, "bridge-info"], [1, "info-item"], [1, "label"], [3, "variant", "text"], [1, "value"]], template: function BridgeStatusCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "mat-card")(1, "mat-card-header")(2, "mat-icon", 0);
      \u0275\u0275text(3, "router");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(8, "mat-card-content")(9, "div", 1)(10, "div", 2)(11, "span", 3);
      \u0275\u0275text(12, "Status");
      \u0275\u0275elementEnd();
      \u0275\u0275element(13, "app-badge", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275template(14, BridgeStatusCardComponent_Conditional_14_Template, 5, 1, "div", 2)(15, BridgeStatusCardComponent_Conditional_15_Template, 5, 1, "div", 2)(16, BridgeStatusCardComponent_Conditional_16_Template, 5, 1, "div", 2);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate(ctx.bridge().ip);
      \u0275\u0275advance(6);
      \u0275\u0275property("variant", ctx.bridge().connected ? "on" : "unreachable")("text", ctx.bridge().connected ? "Connected" : "Disconnected");
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.bridge().api_version ? 14 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.bridge().software_version ? 15 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.bridge().zigbee_channel ? 16 : -1);
    }
  }, dependencies: [MatCardModule, MatCard, MatCardAvatar, MatCardContent, MatCardHeader, MatCardSubtitle, MatCardTitle, MatIconModule, MatIcon, BadgeComponent], styles: ["\n\n.bridge-info[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));\n  gap: 16px;\n}\n.info-item[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.label[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  opacity: 0.6;\n  text-transform: uppercase;\n}\n.value[_ngcontent-%COMP%] {\n  font-weight: 500;\n}\n/*# sourceMappingURL=bridge-status-card.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BridgeStatusCardComponent, [{
    type: Component,
    args: [{ selector: "app-bridge-status-card", standalone: true, imports: [MatCardModule, MatIconModule, BadgeComponent], template: `
    <mat-card>
      <mat-card-header>
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;1b8228bc5b01c6de7ddd0f2c5c9f73a2b61217f718e7c1828f9f5b1c7fd077a5;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/diagnostics/components/bridge-status-card/bridge-status-card.component.ts */\n.bridge-info {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));\n  gap: 16px;\n}\n.info-item {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.label {\n  font-size: 0.75rem;\n  opacity: 0.6;\n  text-transform: uppercase;\n}\n.value {\n  font-weight: 500;\n}\n/*# sourceMappingURL=bridge-status-card.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BridgeStatusCardComponent, { className: "BridgeStatusCardComponent", filePath: "src/app/features/diagnostics/components/bridge-status-card/bridge-status-card.component.ts", lineNumber: 73 });
})();

// src/app/features/diagnostics/components/diagnostics-page/diagnostics-page.component.ts
function DiagnosticsPageComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function DiagnosticsPageComponent_Conditional_9_Conditional_0_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.state.unreachableCount(), " device(s) unreachable");
  }
}
function DiagnosticsPageComponent_Conditional_9_Conditional_0_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13)(1, "mat-icon", 14);
    \u0275\u0275text(2, "battery_alert");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", ctx_r0.state.lowBatteryDevices().length, " device(s) with low battery");
  }
}
function DiagnosticsPageComponent_Conditional_9_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 7)(1, "mat-card-content")(2, "div", 12);
    \u0275\u0275template(3, DiagnosticsPageComponent_Conditional_9_Conditional_0_Conditional_3_Template, 5, 1, "div", 13)(4, DiagnosticsPageComponent_Conditional_9_Conditional_0_Conditional_4_Template, 5, 1, "div", 13);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r0.state.unreachableCount() > 0 ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.state.lowBatteryDevices().length > 0 ? 4 : -1);
  }
}
function DiagnosticsPageComponent_Conditional_9_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-bridge-status-card", 8);
  }
  if (rf & 2) {
    \u0275\u0275property("bridge", ctx);
  }
}
function DiagnosticsPageComponent_Conditional_9_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-device-status-table", 9);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("devices", ctx_r0.state.lights());
  }
}
function DiagnosticsPageComponent_Conditional_9_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-device-status-table", 10);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("devices", ctx_r0.state.sensors());
  }
}
function DiagnosticsPageComponent_Conditional_9_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-device-status-table", 11);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("devices", ctx_r0.state.buttons());
  }
}
function DiagnosticsPageComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, DiagnosticsPageComponent_Conditional_9_Conditional_0_Template, 5, 2, "mat-card", 7)(1, DiagnosticsPageComponent_Conditional_9_Conditional_1_Template, 1, 1, "app-bridge-status-card", 8)(2, DiagnosticsPageComponent_Conditional_9_Conditional_2_Template, 1, 1, "app-device-status-table", 9)(3, DiagnosticsPageComponent_Conditional_9_Conditional_3_Template, 1, 1, "app-device-status-table", 10)(4, DiagnosticsPageComponent_Conditional_9_Conditional_4_Template, 1, 1, "app-device-status-table", 11);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r0.state.unreachableCount() > 0 || ctx_r0.state.lowBatteryDevices().length > 0 ? 0 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional((tmp_2_0 = ctx_r0.state.bridge()) ? 1 : -1, tmp_2_0);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.state.lights().length > 0 ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.state.sensors().length > 0 ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.state.buttons().length > 0 ? 4 : -1);
  }
}
function DiagnosticsPageComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
var DiagnosticsPageComponent = class _DiagnosticsPageComponent {
  state = inject(DiagnosticsStateService);
  ngOnInit() {
  ...
  static \u0275fac = function DiagnosticsPageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DiagnosticsPageComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DiagnosticsPageComponent, selectors: [["app-diagnostics-page"]], decls: 11, vars: 2, consts: [[1, "diagnostics-page"], [1, "page-header"], [1, "flex-spacer"], ["mat-icon-button", "", 3, "click"], [1, "loading-container"], [1, "error-banner"], ["diameter", "40"], [1, "warning-card"], [3, "bridge"], ["title", "Lights", "icon", "lightbulb", 3, "devices"], ["title", "Sensors", "icon", "sensors", 3, "devices"], ["title", "Buttons", "icon", "radio_button_checked", 3, "devices"], [1, "warnings"], [1, "warning-item"], ["color", "warn"]], template: function DiagnosticsPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h2");
      \u0275\u0275text(3, "System Diagnostics");
      \u0275\u0275elementEnd();
      \u0275\u0275element(4, "span", 2);
      \u0275\u0275elementStart(5, "button", 3);
      \u0275\u0275listener("click", function DiagnosticsPageComponent_Template_button_click_5_listener() {
        return ctx.refresh();
      });
      \u0275\u0275elementStart(6, "mat-icon");
      \u0275\u0275text(7, "refresh");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(8, DiagnosticsPageComponent_Conditional_8_Template, 2, 0, "div", 4)(9, DiagnosticsPageComponent_Conditional_9_Template, 5, 5)(10, DiagnosticsPageComponent_Conditional_10_Template, 2, 1, "div", 5);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
      \u0275\u0275conditional(ctx.state.loading() ? 8 : 9);
      \u0275\u0275advance(2);
  ...
  ], styles: ["\n\n.diagnostics-page[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.page-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n}\n.page-header[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 0;\n}\n.loading-container[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  padding: 48px;\n}\n.warning-card[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #fff3e0 0%,\n      #ffe0b2 100%);\n}\nhtml.dark[_nghost-%COMP%]   .warning-card[_ngcontent-%COMP%], html.dark   [_nghost-%COMP%]   .warning-card[_ngcontent-%COMP%] {\n  background:\n    linear-gradient(\n      135deg,\n      #3e2723 0%,\n      #4e342e 100%);\n}\n.warnings[_ngcontent-%COMP%] {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 24px;\n}\n.warning-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.error-banner[_ngcontent-%COMP%] {\n  background-color: #f44336;\n  color: white;\n  padding: 12px 16px;\n  border-radius: 4px;\n}\n/*# sourceMappingURL=diagnostics-page.component.css.map */"], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(DiagnosticsPageComponent, [{
    type: Component,
    args: [{ selector: "app-diagnostics-page", standalone: true, imports: [
      MatCardModule,
      MatButtonModule,
      MatIconModule,
      MatProgressSpinnerModule,
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;54ce1678b0583ddbd51fbceb192e7b7f426a62cbeb8cce8d5f8bf3a93ac1881e;/Users/michaelebert/Projects/loxhuebridge/frontend/src/app/features/diagnostics/components/diagnostics-page/diagnostics-page.component.ts */\n.diagnostics-page {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.page-header {\n  display: flex;\n  align-items: center;\n  gap: 16px;\n}\n.page-header h2 {\n  margin: 0;\n}\n.loading-container {\n  display: flex;\n  justify-content: center;\n  padding: 48px;\n}\n.warning-card {\n  background:\n    linear-gradient(\n      135deg,\n      #fff3e0 0%,\n      #ffe0b2 100%);\n}\n:host-context(html.dark) .warning-card {\n  background:\n    linear-gradient(\n      135deg,\n      #3e2723 0%,\n      #4e342e 100%);\n}\n.warnings {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 24px;\n}\n.warning-item {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.error-banner {\n  background-color: #f44336;\n  color: white;\n  padding: 12px 16px;\n  border-radius: 4px;\n}\n/*# sourceMappingURL=diagnostics-page.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DiagnosticsPageComponent, { className: "DiagnosticsPageComponent", filePath: "src/app/features/diagnostics/components/diagnostics-page/diagnostics-page.component.ts", lineNumber: 142 });
})();

// src/app/features/diagnostics/diagnostics.routes.ts
var DIAGNOSTICS_ROUTES = [
  { path: "", component: DiagnosticsPageComponent }
];
export {
  DIAGNOSTICS_ROUTES
};
//# sourceMappingURL=chunk-KYNJCTIU.js.map
