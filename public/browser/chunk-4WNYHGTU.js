...
var ApiService = class _ApiService {
  ...
  // Targets (Hue devices)
  getTargets() {
    return this.http.get(`${this.baseUrl}/targets`).pipe(catchError(this.handleError));
  }
  // Mappings
  getMappings() {
    return this.http.get(`${this.baseUrl}/mapping`).pipe(catchError(this.handleError));
  }
  addMapping(mapping) {
    return this.http.post(`${this.baseUrl}/mapping`, mapping).pipe(catchError(this.handleError));
  }
  updateMapping(loxoneName, update) {
    return this.http.put(`${this.baseUrl}/mapping/${encodeURIComponent(loxoneName)}`, update).pipe(catchError(this.handleError));
  }
  deleteMapping(loxoneName) {
    return this.http.delete(`${this.baseUrl}/mapping/${encodeURIComponent(loxoneName)}`).pipe(catchError(this.handleError));
  }
  // Status
  getStatus() {
    return this.http.get(`${this.baseUrl}/status`).pipe(catchError(this.handleError));
  }
  // Detected commands
  getDetected() {
    return this.http.get(`${this.baseUrl}/detected`).pipe(catchError(this.handleError));
  }
  clearDetected() {
    return this.http.delete(`${this.baseUrl}/detected`).pipe(catchError(this.handleError));
  }
  // Scenes
  getScenes() {
    return this.http.get(`${this.baseUrl}/scenes`).pipe(catchError(this.handleError));
  }
  activateScene(uuid) {
    return this.http.post(`/scene/${uuid}/on`, {}).pipe(catchError(this.handleError));
  }
  deactivateScene(uuid) {
    return this.http.post(`/scene/${uuid}/off`, {}).pipe(catchError(this.handleError));
  }
  // Loxone controls
  getLoxoneControls() {
    return this.http.get(`${this.baseUrl}/loxone/controls`).pipe(map((response) => response.controls || []), catchError(this.handleError));
  }
  sendLoxoneCommand(uuid, command) {
    return this.http.post(`${this.baseUrl}/loxone/command`, { uuid, command }).pipe(catchError(this.handleError));
  }
  // Settings
  getSettings() {
    return this.http.get(`${this.baseUrl}/settings`).pipe(catchError(this.handleError));
  }
  updateSettings(settings) {
    return this.http.put(`${this.baseUrl}/settings`, settings).pipe(catchError(this.handleError));
  }
  // Logs
  getLogs() {
    return this.http.get(`${this.baseUrl}/logs`).pipe(catchError(this.handleError));
  }
  clearLogs() {
    return this.http.delete(`${this.baseUrl}/logs`).pipe(catchError(this.handleError));
  }
  // Diagnostics
  getDiagnostics() {
    return this.http.get(`${this.baseUrl}/diagnostics`).pipe(catchError(this.handleError));
  }
  // Export
  downloadExport(type) {
  ...
  // Setup
  discoverBridges() {
    return this.http.get(`${this.baseUrl}/setup/discover`).pipe(catchError(this.handleError));
  }
  registerBridge(ip) {
    return this.http.post(`${this.baseUrl}/setup/register`, { ip }).pipe(catchError(this.handleError));
  }
  saveLoxoneConfig(config) {
    return this.http.post(`${this.baseUrl}/setup/loxone`, config).pipe(catchError(this.handleError));
  }
  checkSetupStatus() {
    return this.http.get(`${this.baseUrl}/setup/status`).pipe(catchError(this.handleError));
  }
  // Light command (direct control)
  sendLightCommand(name, value) {
    return this.http.get(`/${encodeURIComponent(name)}/${encodeURIComponent(value)}`).pipe(catchError(this.handleError));
  }
  handleError(error) {
...
//# sourceMappingURL=chunk-4WNYHGTU.js.map
